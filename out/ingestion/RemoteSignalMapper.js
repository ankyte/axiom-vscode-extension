...
exports.RemoteSignalMapper = void 0;
class RemoteSignalMapper {
    constructor(azure) {
        this.azure = azure;
    }
    async fromRepository(repo) {
        ...
        const signals = [];
        for (const pr of details.filter((item) => item !== null)) {
            signals.push({
...
exports.RemoteSignalMapper = RemoteSignalMapper;
//# sourceMappingURL=RemoteSignalMapper.js.map